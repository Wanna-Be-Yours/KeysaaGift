...
export default function FlowerPage() {
  ...
  useEffect(() => {
    ...
    const playAudioOnInteraction = () => {
      if (audioRef.current) {
        ...
        }).catch(err => console.log("Audio failed to auto-play:", err));
      }
  ...
  return (
    <AuthGuard>
      <div className={`flower-body ${loaded ? "" : "not-loaded"}`}>
        ...
        <audio ref={audioRef} loop src="/Menu/flower/music/plowers.mp3"></audio>
      </div>
    </AuthGuard>
  );
}
