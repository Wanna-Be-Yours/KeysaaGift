      ...
      <div className="profile-container">
        ...
        <div className="profile-card">
          ...
          <div className="profile-image-container">
            ...
            <Image src="/Menu/profile/profile.webp" alt="Profile Picture" className="profile-image" width={180} height={180} priority />
          </div>

          <h1 className="profile-name">Keysa Putri Fatima</h1>
          ...
          <div className="profile-details">
            ...
            <div className="detail-item" onClick={handleDetailClick}>
              ...
              <div className="detail-content">
                ...
                <div className="detail-value">Unknown</div>
              </div>
            </div>
          </div>
          ...
          <div className="about-section">
            <div className="about-title">
              ...
              Tentang nya dari penulis
            </div>
            <p className="about-text">
              Dia wanita yang sangat cantik, manis lucu.
              untuk sekarang hanya itu yang bisa aku ucapkan disini, mungkin semakin lama bakalan semakin tauu gimana orangnya.
            </p>
          </div>
        </div>
      </div>
